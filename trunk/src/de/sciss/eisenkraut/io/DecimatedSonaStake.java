 ...
 */
public class DecimatedSonaStake
extends BasicStake
{
	...
	public DecimatedSonaStake( Span span, InterleavedStreamFile[] fs, Span[] fileSpans, Span[] biasedSpans,
						   	   DecimationHelp[] decimations )
	{
		this( span, fs, fileSpans, fileSpans, null, biasedSpans, decimations );
	}
	
	private DecimatedSonaStake( Span span, InterleavedStreamFile[] fs, Span[] fileSpans,
...
//		}
//	
//		return new DecimatedSonaStake( newSpan, f, newFileSpan, maxFileSpan );
//	}

	public Stake duplicate()
	{
		return new DecimatedSonaStake( span, fs, fileSpans, maxFileSpans, framesWritten, biasedSpans, decimations );
	}
	...
	public Stake replaceStart( long newStart )
	{
		...
		return new DecimatedSonaStake( span.replaceStart( newStart ), fs, newFileSpans, maxFileSpans, framesWritten, newBiasedSpans, decimations );
	}
...
//	}
	...
	public Stake replaceStop( long newStop )
	{
		...
		return new DecimatedSonaStake( span.replaceStop( newStop ), fs, newFileSpans, maxFileSpans, framesWritten, newBiasedSpans, decimations );
	}
	...
	public Stake shiftVirtual( long delta )
	{
		...
		return new DecimatedSonaStake( span.shift( delta ), fs, fileSpans, maxFileSpans, framesWritten, newBiasedSpans, decimations );
	}
