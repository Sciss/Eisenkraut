...
//		final NumberSpace	spcSpread	= new NumberSpace( -1.0, 1.0, 0.1 );
        ...
        map.putContext( this, MAP_KEY_PAN_AZIMUTH, new MapManager.Context( MapManager.Context.FLAG_OBSERVER_DISPLAY,
                                                                           ...
                                                                           null, 0.0));
        map.putContext( this, MAP_KEY_PAN_SPREAD, new MapManager.Context( MapManager.Context.FLAG_OBSERVER_DISPLAY,
...
//		return new Integer( getFlags() );
    ...
    {
        return getMap().getValue(MAP_KEY_PAN_AZIMUTH);
    }

    public Object oscQuery_panSpread()
    {
        return getMap().getValue(MAP_KEY_PAN_SPREAD);
    }
